...
`define DEVICE_PROJ_NAME   "GPU"
`define DEVICE_PROJ_DESC   "Group13：GPU"
...
`define PIPELINE_DATAPATH_REG_ADDR_WIDTH    5
`define GPU_BLOCK_ADDR_WIDTH                19
`define GPU_REG_ADDR_WIDTH                  5
...
`define PIPELINE_DATAPATH_BLOCK_ADDR  19'h0000d
`define GPU_BLOCK_ADDR  19'h0000d
...
// Description: Registers for Pipeline Datapath IP
// File: projects/lab5/include/pipeline_datapath.xml
`define PIPELINE_IMEM_INTERACT        5'h00
`define PIPELINE_IMEM_WRITE           5'h01
`define PIPELINE_IMEM_RW_ADDRESS      5'h02
`define PIPELINE_IMEM_WDATA           5'h03
`define PIPELINE_DMEM_INTERACT        5'h04
`define PIPELINE_DMEM_WRITE           5'h05
`define PIPELINE_DMEM_RW_ADDRESS      5'h06
`define PIPELINE_DMEM_WDATA_UPPER     5'h07
`define PIPELINE_DMEM_WDATA_LOWER     5'h08
`define PIPELINE_IMEM_RDATA           5'h09
`define PIPELINE_DMEM_RDATA_UPPER     5'h0A
`define PIPELINE_DMEM_RDATA_LOWER     5'h0B

// Name: gpu_top
// Description: Registers for GPU Top IP
// File: projects/labX/include/gpu_top.xml
`define GPU_IMEM_INTERACT        5'h00
`define GPU_IMEM_WRITE           5'h01
`define GPU_IMEM_RW_ADDRESS      5'h02
`define GPU_IMEM_WDATA           5'h03
`define GPU_DMEM_INTERACT        5'h04
`define GPU_DMEM_WRITE           5'h05
`define GPU_DMEM_RW_ADDRESS      5'h06
`define GPU_DMEM_WDATA_UPPER     5'h07
`define GPU_DMEM_WDATA_LOWER     5'h08
`define GPU_IMEM_RDATA           5'h09
`define GPU_DMEM_RDATA_UPPER     5'h0A
`define GPU_DMEM_RDATA_LOWER     5'h0B
