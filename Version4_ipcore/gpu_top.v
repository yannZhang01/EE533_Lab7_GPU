...
gpu_dmem_ip dmem (
    // inputs
    .addrb(mem_final_result[DATA_ADDR_WIDTH-1:0]), // use lower bits of address for memory indexing
    .addra(mem_final_result[DATA_ADDR_WIDTH-1:0]), // use lower bits of address for memory indexing
    .dina(mem_rs2_data),
    .wea(mem_mwrite_en),
    .clk(clk),
